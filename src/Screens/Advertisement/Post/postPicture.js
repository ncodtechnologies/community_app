...
const options = {
  ...
  storageOptions: {
    ...
    avatarSource: '../../../Images/Ads/add_image.png',
  },
};
...
export default class PostPicture extends Component {
  ...
  state = {
    avatar : require('../../../Images/Ads/add_image.png')
  }
...
uploadPicture = () => {
  ...
  console.log("Request");
    ...
    const {avatarSource} = '../../../Images/Ads/add_image.png';
        ...
        <Content>
          <Card >
            ...
            <CardItem button  onPress={() => this.OpenImagePicker()} >
                <Image   source={require('../../../Images/Ads/add_image.png')}  style={{height: 350, width: null, flex: 1}}/>
            </CardItem>
            <CardItem>
              <Body>
                <View style={{ marginTop:20, justifyContent: 'flex-end', flexDirection: 'row', flex:1 }}>
                  ...
                  <Button style={{ backgroundColor:"#0574CA" }}   
                           onPress={() => this.props.navigation.navigate("PostTitle", {ad: this.state.ad})}  >
                    <Text> >> </Text>
                  </Button>
